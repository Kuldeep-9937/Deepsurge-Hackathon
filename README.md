# 📊 CSV-to-Chart & Insight Generator

Turn your raw CSV data into **beautiful charts and instant insights** effortlessly.  
Built using **React + Vite**, this web app lets you upload CSV files, preview the data,  
and (in the next version) automatically visualize insights using **Chart.js** and **AI integration**.
...
|-------------|------|-------------|
| **React.js** | <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/react/react-original.svg" width="40"/> | JavaScript library for building dynamic, component-based UIs.  |
| **Vite** | <img src="https://vitejs.dev/logo.svg" width="40"/> | Lightning-fast development server and bundler for modern web apps. |
